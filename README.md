...
<p>Recording Indicator Utility supports <a href="https://support.apple.com/macos/upgrade">macOS Monterey</a>, including macOS version 12.3.1, 12.3, 12.2.1, 12.2, 12.1, 12.0.1, and 12.0.</p>
...
Recording Indicator Utility supports [macOS Monterey](https://support.apple.com/macos/upgrade) version 12.3.1, 12.3, 12.2.1, 12.2, 12.1, 12.0.1, and 12.0, allows you to turn off the recording indicator in any app, and requires adjusting security settings.
